...
class Billplz extends PaymentModule {
    ...
    public function hookPayment($params) {
        ...
        $this->smarty->assign(array(
            ...
            'redirecturl' => $this->context->link->getModuleLink($this->name, 'return', array(), true) . '&signature=' . $signature,
            'callbackurl' => $this->context->link->getModuleLink($this->name, 'callback', array(), true) . '&signature=' . $signature,
            'signature' => $signature,
